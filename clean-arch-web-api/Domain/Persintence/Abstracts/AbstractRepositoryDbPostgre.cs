...
{
    public class AbstractRepositoryDbPostgre<ImplementedClass> : IAbstractRepositoryDb<ImplementedClass> where ImplementedClass : AbstractEntity
    {
        private readonly IConnectionManager _connectionManager;
        public AbstractRepositoryDbPostgre(IConnectionManager connectionManager)
        {
